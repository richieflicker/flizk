...
const features = [
  ...
  },
  {
    ...
    description:
      "Intuitive calendar view with drag-and-drop scheduling. Automated WhatsApp, SMS, and email reminders to reduce no-shows.",
  },
  {
    icon: ClipboardList,
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Plans for single clinics and multi-location networks. Contact us for a quote
                      tailored to your practice — no long-term contracts required.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
