...
const benefits = [
  {
    icon: Clock,
    title: "Save Time",
    description: "Reduce administrative workload by up to 60% with automated workflows and smart scheduling.",
    color: "bg-blue-100",
  ...
  },
  {
    icon: Zap,
    title: "Fast & Reliable",
    description: "Lightning-fast performance with 99.9% uptime. Your clinic never stops.",
    color: "bg-pink-100",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Join hundreds of dental clinics that have transformed their practice with modern
            technology
          </p>
        </div>
